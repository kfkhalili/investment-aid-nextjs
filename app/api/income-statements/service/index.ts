...
import type { IncomeStatement, IncomeStatementDoc } from "./types";

// --- Create the Income Statement Service Instance ---

const incomeStatementService = createGenericService(incomeStatementConfig);
 ...
 * @returns {Promise<IncomeStatement[]>} An array of statements (potentially partial if listProjection is used).
 */
 ...
 * @returns {Promise<Collection<IncomeStatementDoc>>}
 */
export const getIncomeStatementCollection =
  incomeStatementService.getCollection;
...
export type { IncomeStatement, IncomeStatementDoc };
