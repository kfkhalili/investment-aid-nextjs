...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="group rounded-full bg-white/90 px-3 py-2 ring-1 shadow-lg ring-zinc-900/5 backdrop-blur-sm transition dark:bg-zinc-800/90 dark:ring-white/10"
